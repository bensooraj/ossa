 ...
 * 
 * @property {String} on A valid timestamp.
 * 
...
class Ossa extends EventEmitter {
     ...
     * @summary Get a notificationID's time to live remaining and associated payload, if it exists and if it hasn't expired yet
