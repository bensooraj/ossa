...
class Hermes extends EventEmitter {
    constructor(options = {}) {
        ...
        log("hermes_payload_store: %s", this.hermes_payload_store);
        log("hermes_processing_queue: %s", this.hermes_processing_queue);
        ...
        log(`Subscriber subscribed to: __keyspace@0__:${this.hermes_processing_queue}`)
    }
